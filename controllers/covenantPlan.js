...
require("../models/CovenantPlan.js")
const tokenok = require("../config/tokenValidate.js")

const ModelName = mongoose.model("CovenantPlan")
const routeName = "/covenantplan"
...
module.exports = app => {
    ...
    app.get(routeName + "name/:name", tokenok, async (req, res) => {   // + _tn
